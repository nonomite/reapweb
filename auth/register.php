                ...
                if ($stmt->num_rows > 0) {
                    ...
                    if (password_verify($password, $hashed_password)) {
                        ...
                        if ($_SESSION['role'] === 'APP') {
                            ...
                            $applicant_stmt->bind_param("s", $_SESSION['account_id']);
...
<body>
    <div class="w-25" style="padding-bottom: 1rem;">
        <div class="custom-form  rounded ms-auto">
            <h2 class="">Want to be a REAP Scholar? <br> Create an account first to submit an application.</h2>
        </div>
    </div>
    <main class="form-signin w-50 p-4">
        <form id="authForm" class="custom-form " action="register.php" method="POST">
            <div class="text-center mb-4">
                <a href="../index.php" class="navbar-brand text-decoration-none d-inline-block">
                    <i class="bi-bullseye brand-logo" style="font-size: 6rem;"></i>
                    <span class="brand-text h2 align-middle ms-2">REAPWEB <br> APPLICATION</span>
                </a>
                <h1 id="form-title" class="h3 mt-3 mb-3 fw-normal">CREATE ACCOUNT</h1>
            </div>
            ...
            <div class="form-floating mb-3 registration-field" >
            ...
            <button id="submit-button" class="w-100 btn btn-lg btn-primary" type="submit">Register</button>

            <p id="login-link" class="text-center mt-4" >
                Already have an account? <a href="#" id="showLogin">Login</a>
            </p>
            <p id="register-link" class="text-center mt-4" style="display: none;">
