            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#"><?php echo($_SESSION['username']);?></a>
                            <a class="nav-link click-scroll" href="#"><?php echo($_SESSION['applicant_id']);?></a>
                        </li>

                        <li class="nav-item padding">
                            <div class="dropdown">
                                <img padding="10px" height="45px" width="45px" src="images/avatar/user-avatar.png" data-bs-toggle="dropdown" class="dropdown" alt="">
                                <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a href="account-profile.php">Account Profile</a></li> 
                                    <li class="dropdown-item"><a href="applicant-profile.php">View my application</a></li>    
                                    <li class="dropdown-item"><a href="application.php">Apply Now</a></li>    
                                    <li class="dropdown-item"><a href="auth/destroy.php">Log Out</a></li>    
                                </ul>
                            </div>
                        </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <h3 class="mb-3">Southville's Scholarship 2025</h3>

                            <p>Our scholarship program at Southville International School and Colleges offers a unique opportunity for working students who wish to pursue higher education while managing their daily responsibilities. Southville offers two-year IT courses that can be a stepping stone toward further studies. Eligible applicants can apply for a full scholarship in either of our two specialized IT tracks: Information Systems Technician (IST) and Information Systems Management (ISM).

These courses are part of our night school program, specially designed to accommodate students who work during the day. After completing the two-year program, scholars have the option to continue their studies and pursue their dream course at Southville, fully supported and guided by our academic community.

We are committed to providing accessible, flexible, and high-quality education to help students build a strong foundation in IT and unlock greater opportunities for their future.</p>
                            <h4>Take the first step toward your success. Apply now and become a Southville scholar!</h4>

                            <a class="custom-btn custom-border-btn btn custom-link mt-3 me-3" href="#section_3">Programs Offers</a>

                            <a class="custom-btn btn custom-link mt-3" href="application.php">Apply Now</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="speakers-text-info">
                                ...
                                <p>At Southville International School and Colleges, we are proud to offer scholarship opportunities that empower working students to achieve their educational goals. Our scholarship programs are designed to support individuals who are committed to balancing work and study while pursuing a career in the field of Information Technology.</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-lg-3 col-12 ms-lg-auto mt-4 mt-lg-0">
                            <a href="application.php" class="custom-btn btn">Apply Now</a>
                        </div>
